    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg text-center">
          TextInquirer allows you to have conversation with any PDF document. Simply upload your file and start asking questions right away.
        </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF has never been easier than with TextInquirer
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex space-y-2 flex-col border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
          ...
          <li className="md:flex-1">
            <div className="flex space-y-2 flex-col border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple try out TextInquirer today - it really take less than a minute.
              </span>
            </div>
          </li>
        </ol>
